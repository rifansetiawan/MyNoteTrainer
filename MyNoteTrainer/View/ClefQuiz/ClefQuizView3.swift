...
struct ClefQuizView3: View {
    ...
    var body: some View {
        ...
        VStack{
            ...
            Button(action:
                    {
                if location.y <= -67 && location.y >= -75 {
            ...
            if(isShowSuccessPopUp) {
                PopUpCorrectQuizView(onPressSecondary: {
...
struct ClefQuizView3_Previews: PreviewProvider {
    static var previews: some View {
        ClefQuizView3(index: .constant(3))
    }
}
